...
export const BetterCall = styled.h1.attrs((props) => ({
    ...
    text-shadow:
        ...
        rgb(255, 255, 255) -2px 1px 0px,
        rgb(255, 255, 255) -2px 2px 0px,
        rgb(255, 255, 255) -1px -2px 0px,
        rgb(255, 255, 255) -1px -1px 0px,
        rgb(255, 255, 255) -1px 0px 0px,
        rgb(255, 255, 255) -1px 1px 0px,
        rgb(255, 255, 255) -1px 2px 0px,
        rgb(255, 255, 255) 0px -2px 0px,
...
export const BizerkContainer = styled.div`
    ...
    &.bizerk {
        animation: ${scalingYoyo(1, 2)} 1s cubic-bezier(0.055, 0.825, 0.485, 0.85) infinite alternate;
    }
...
export const SalName = styled.h2.attrs((props) => ({
    className: props.className,
}))`
    color: white;
    ...
    &.bizerk {
        animation: ${scalemic} 1s cubic-bezier(0.055, 0.825, 0.485, 0.85) infinite alternate;
    }
`;
...
export const SalCaption = styled.h3`
    ...
    &.bizerk {
        animation: ${scalingYoyo(1, 2.5)} 1.05s cubic-bezier(0.055, 0.825, 0.485, 0.85) infinite alternate;
    }
    @media only screen and (max-width: ${breakPoints.sm.max}px) {
        //text-align: left;
        margin: -6px 0 0 16px;
