                    ...
                    for (; o && ((o = 0), c[0] && (u = 0)), u; )
                        try {
                            if (
                                ((n = 1),
                                r &&
                                    (i = 2 & c[0] ? r.return : c[0] ? r.throw || ((i = r.return) && i.call(r), 0) : r.next) &&
                                    !(i = i.call(r, c[1])).done)
                            )
                                return i;
    ...
    function s(t, e) {
        return (
            ...
            t.toBlob
                ...
                : new Promise(function (n) {
                      for (
                          var r = window.atob(t.toDataURL(e.type ? e.type : void 0, e.quality ? e.quality : void 0).split(',')[1]),
                              i = r.length,
                              o = new Uint8Array(i),
                              u = 0;
                          u < i;
                    ...
                    case 0:
                        if (
                            ((e = (function (t, e, n) {
                                var r = t.replace(/\?.*/, '');
                                return (
                                    n && (r = t), /ttf|otf|eot|woff2?/i.test(r) && (r = r.replace(/.*\//, '')), e ? '['.concat(e, ']').concat(r) : r
                                );
            ...
            return n(this, function (e) {
                switch (e.label) {
                    case 0:
                        return (
                            e.trys.push([0, 3, , 4]),
                            (null === (r = null == t ? void 0 : t.contentDocument) || void 0 === r ? void 0 : r.body)
                                ? [4, N(t.contentDocument.body, {}, !0)]
                                : [3, 2]
                        );
                    case 1:
                        return [2, e.sent()];
    ...
    function F(t, r, i) {
        ...
        return e(this, void 0, void 0, function () {
            ...
            return n(this, function (n) {
                switch (n.label) {
                    case 0:
                        return (e = null === (o = r.style) || void 0 === o ? void 0 : o.getPropertyValue(t)) ? [4, V(e, null, i)] : [3, 2];
                    case 1:
    ...
    function j(t, r) {
        return e(this, void 0, void 0, function () {
            return n(this, function (e) {
                switch (e.label) {
                    case 0:
                        return [4, F('background', t, r)];
                    case 1:
                        return e.sent() ? [3, 3] : [4, F('background-image', t, r)];
                    case 2:
                        e.sent(), (e.label = 3);
                    case 3:
                        return [4, F('mask', t, r)];
                    case 4:
                        return e.sent() ? [3, 6] : [4, F('mask-image', t, r)];
                    case 5:
                        e.sent(), (e.label = 6);
                    case 6:
                        return [2];
    ...
    function q(t, r) {
        return e(this, void 0, void 0, function () {
            ...
            return n(this, function (n) {
                switch (n.label) {
                    case 0:
                        return ((e = d(t, HTMLImageElement)) && !y(t.src)) || (d(t, SVGImageElement) && !y(t.href.baseVal))
    ...
    function O(t, r) {
        return e(this, void 0, void 0, function () {
            return n(this, function (e) {
                switch (e.label) {
                    case 0:
                        return d(t, Element) ? [4, j(t, r)] : [3, 4];
                    case 1:
                        return e.sent(), [4, q(t, r)];
                    case 2:
                        return e.sent(), [4, U(t, r)];
                    case 3:
                        e.sent(), (e.label = 4);
                    case 4:
                        return [2];
    ...
    function z(t) {
        return e(this, void 0, void 0, function () {
            ...
            return n(this, function (n) {
                switch (n.label) {
                    case 0:
                        return null != (e = B[t]) ? [2, e] : [4, fetch(t)];
                    case 1:
                        return [4, n.sent().text()];
                    case 2:
                        return (r = n.sent()), (e = { url: t, cssText: r }), (B[t] = e), [2, e];
                }
            });
        });
    }
            ...
            return n(this, function (e) {
                switch (e.label) {
                    case 0:
                        ...
                        return [4, _(o(t.ownerDocument.styleSheets), r)];
                    case 1:
                        return [2, G(e.sent())];
                }
            });
        ...
        return (
            ...
            e(this, void 0, void 0, function () {
                ...
                return n(this, function (n) {
                    switch (n.label) {
                        case 0:
                            return (e = c(t, r)), (i = e.width), (o = e.height), [4, N(t, r, !0)];
                        case 1:
                            return [4, X((u = n.sent()), r)];
                        case 2:
                            return n.sent(), [4, O(u, r)];
                        case 3:
                            return (
                                n.sent(),
                                (function (t, e) {
            ...
            return (
                ...
                e(this, void 0, void 0, function () {
                    ...
                    return n(this, function (n) {
                        switch (n.label) {
                            case 0:
                                return (e = c(t, r)), (i = e.width), (o = e.height), [4, Y(t, r)];
                            case 1:
